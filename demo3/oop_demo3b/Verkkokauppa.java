...
public class Verkkokauppa {
    ...
    public String listaaAsiakkaat() {
        ...
        ArrayList<Asiakas> asiakkaat_lista = new ArrayList<>(asiakkaat.values());
        for (Asiakas asiakas : asiakkaat_lista) {
    ...
    public String listaaMyyjat() {
        ...
        ArrayList<Myyja> myyjat_lista = new ArrayList<>(myyjat.values());
        for (Myyja myyja : myyjat_lista) {
    ...
    public String listaaTuotteet() {
        ...
        ArrayList<Tuote> tuotteet_lista = new ArrayList<>(tuotteet.values());
        for (Tuote tuote : tuotteet_lista) {
